    ...
    if (messages.first()) {
        ...
        const components = [{
        ...
        },
            {
                type: 'ACTION_ROW',
                components: [
                    {type: 'BUTTON', label: localize('temp-channels', 'public-channel'), style: 'SUCCESS', customId: 'tempc-public', emoji: '🔓'},
                    {type: 'BUTTON', label: localize('temp-channels', 'private-channel'), style: 'DANGER', customId: 'tempc-private', emoji: '🔒'},
