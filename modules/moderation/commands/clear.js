...
module.exports.run = async function (client, msg, args) {
    ...
    if (!msg.member.roles.cache.find(r => moduleConfig['moderator-roles_level3'].includes(r.id) || moduleConfig['moderator-roles_level4'].includes(r.id))) return msg.channel.send(...embedType(moduleStrings['no_permissions'], {
        '%required_level%': 3
    }));
