...
async function leaderboard(client) {
    ...
    if (moduleStr['leaderboardEmbed']['thumbnail'].trim() !== '') embed.setThumbnail(moduleStr['leaderboardEmbed']['thumbnail']);
    if (moduleStr['leaderboardEmbed']['image'].trim() !== '') embed.setImage(moduleStr['leaderboardEmbed']['image']);
